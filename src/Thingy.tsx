...
import GroupedExample from "./GroupedExample";
        ...
        >
            ...
            <div>
                ...
                <TabPanel value={currentTab} index={0}>
                    <CheckboxExample handleClose={handleClose} />
                </TabPanel>
                <TabPanel value={currentTab} index={1}>
                    <GroupedExample handleClose={handleClose} />
                </TabPanel>
